...
for i in total:
    ...
    contador =contador+1
    totalmes = totalmes + i
    Diastotales.append("DIA "+ str(contador) )
...
categorias = ['Ropa','Transporte','Entretenimiento','Comida','emergencias']
valores = [totalropa,totaltransporte,totalentrete,totalcomida,totalemergencias]
plt.figure(figsize=(10,5))
plt.bar(categorias,valores)
plt.bar(Diastotales,total)
plt.title("Contador ACMUD")
plt.xlabel("CATEGORIAS DE GASTOS")
plt.ylabel("Valor de los gastos $")
plt.show()
